...
export const QUICK_CHARACTERS: QuickCharacter[] = [
  ...
  },
  {
    ...
    gradient: "from-neutral-700 via-neutral-900 to-neutral-800",
    avatarBg: "bg-neutral-800",
    accentColor: "#4d463b",
    expression: "smooth",
  ...
  },
  {
    ...
    gradient: "from-neutral-500 via-neutral-600 to-neutral-700",
  ...
  },
  {
    ...
    gradient: "from-neutral-500 via-neutral-700 to-neutral-900",
    avatarBg: "bg-neutral-700",
    accentColor: "#6f685c",
    expression: "ghost",
